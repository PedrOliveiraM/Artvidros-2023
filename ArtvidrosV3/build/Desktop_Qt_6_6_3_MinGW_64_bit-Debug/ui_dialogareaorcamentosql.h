...
public:
    ...
    void setupUi(QDialog *DialogAreaOrcamentoSQL)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/imagens/olho.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/imagens/voltar.png"), QSize(), QIcon::Normal, QIcon::Off);
