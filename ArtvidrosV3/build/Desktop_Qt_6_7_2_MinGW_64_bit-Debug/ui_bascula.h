/********************************************************************************
** Form generated from reading UI file 'bascula.ui'
**
...
public:
    ...
    void setupUi(QDialog *Bascola)
    {
        if (Bascola->objectName().isEmpty())
            Bascola->setObjectName("Bascola");
        Bascola->resize(1366, 768);
        pushButtonSalvar = new QPushButton(Bascola);
        pushButtonSalvar->setObjectName("pushButtonSalvar");
        pushButtonSalvar->setGeometry(QRect(830, 580, 51, 41));
        QIcon icon;
        ...
        pushButtonLimpar = new QPushButton(Bascola);
        pushButtonLimpar->setObjectName("pushButtonLimpar");
        pushButtonLimpar->setGeometry(QRect(830, 630, 51, 41));
        QIcon icon1;
        ...
        label = new QLabel(Bascola);
        label->setObjectName("label");
        label->setGeometry(QRect(490, 90, 441, 141));
        QFont font;
        font.setFamilies({QString::fromUtf8("Matura MT Script Capitals")});
        font.setPointSize(72);
        font.setBold(false);
        label->setFont(font);
        layoutWidget = new QWidget(Bascola);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(580, 630, 221, 41));
        ...
        layoutWidget_2 = new QWidget(Bascola);
        layoutWidget_2->setObjectName("layoutWidget_2");
        layoutWidget_2->setGeometry(QRect(570, 330, 311, 71));
        ...
        layoutWidget_3 = new QWidget(Bascola);
        layoutWidget_3->setObjectName("layoutWidget_3");
        layoutWidget_3->setGeometry(QRect(600, 420, 211, 71));
        ...
        layoutWidget_5 = new QWidget(Bascola);
        layoutWidget_5->setObjectName("layoutWidget_5");
        layoutWidget_5->setGeometry(QRect(270, 330, 131, 71));
        ...
        pushButtonRefatorando = new QPushButton(Bascola);
        ...
        pushButtonCalcular = new QPushButton(Bascola);
        pushButtonCalcular->setObjectName("pushButtonCalcular");
        pushButtonCalcular->setGeometry(QRect(540, 530, 281, 41));
        ...
        pushButtonDesconto = new QPushButton(Bascola);
        pushButtonDesconto->setObjectName("pushButtonDesconto");
        pushButtonDesconto->setGeometry(QRect(830, 530, 51, 41));
        QIcon icon3;
        ...
        layoutWidget_6 = new QWidget(Bascola);
        layoutWidget_6->setObjectName("layoutWidget_6");
        layoutWidget_6->setGeometry(QRect(580, 580, 221, 41));
        ...
        layoutWidget_7 = new QWidget(Bascola);
        layoutWidget_7->setObjectName("layoutWidget_7");
        layoutWidget_7->setGeometry(QRect(890, 330, 211, 71));
        ...
        layoutWidget_8 = new QWidget(Bascola);
        layoutWidget_8->setObjectName("layoutWidget_8");
        layoutWidget_8->setGeometry(QRect(420, 330, 131, 71));
        ...
        layoutWidget_9 = new QWidget(Bascola);
        layoutWidget_9->setObjectName("layoutWidget_9");
        layoutWidget_9->setGeometry(QRect(370, 420, 211, 71));
        ...
        retranslateUi(Bascola);

        QMetaObject::connectSlotsByName(Bascola);
    } // setupUi

    void retranslateUi(QDialog *Bascola)
    {
        Bascola->setWindowTitle(QCoreApplication::translate("Bascola", "Dialog", nullptr));
        pushButtonSalvar->setText(QString());
        pushButtonLimpar->setText(QString());
        label->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p>B\303\241scula<br/></p></body></html>", nullptr));
        label_6->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">LUCRO</span></p></body></html>", nullptr));
#if QT_CONFIG(whatsthis)
        lineEditLucro->setWhatsThis(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><br/></p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
        labelVidros->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Vidros</span></p></body></html>", nullptr));
        comboBoxVidros->setItemText(0, QString());

        label_5->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Trinco</span></p></body></html>", nullptr));
        comboBoxTrinco->setItemText(0, QString());

        labelLargura->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Largura</span></p></body></html>", nullptr));
        pushButtonRefatorando->setText(QCoreApplication::translate("Bascola", "Adicionais", nullptr));
        pushButtonCalcular->setText(QCoreApplication::translate("Bascola", "CALCULAR", nullptr));
        pushButtonDesconto->setText(QString());
        label_4->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">VALOR</span></p></body></html>", nullptr));
        label_3->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Kit</span></p></body></html>", nullptr));
        comboBoxKit->setItemText(0, QString());

        labelAltura->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Altura</span></p></body></html>", nullptr));
        label_7->setText(QCoreApplication::translate("Bascola", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Pel\303\255cula</span></p></body></html>", nullptr));
...
namespace Ui {
    class Bascola: public Ui_Bascola {};
} // namespace Ui
