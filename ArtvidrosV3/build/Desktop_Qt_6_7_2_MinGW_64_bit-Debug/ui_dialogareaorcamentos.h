...
public:
    ...
    void setupUi(QDialog *Dialogareaorcamentos)
    {
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/imagens/excluir.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/imagens/limpar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
