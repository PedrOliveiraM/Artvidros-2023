...
public:
    ...
    void setupUi(QDialog *DialogAreaPrecos)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/imagens/botao-adicionar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/imagens/alterar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/imagens/excluir Normal.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/imagens/ordenar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
