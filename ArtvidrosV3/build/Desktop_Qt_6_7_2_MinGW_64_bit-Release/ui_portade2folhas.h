...
public:
    ...
    void setupUi(QDialog *PortaDe2Folhas)
    {
        if (PortaDe2Folhas->objectName().isEmpty())
            PortaDe2Folhas->setObjectName("PortaDe2Folhas");
        PortaDe2Folhas->resize(1366, 768);
        label = new QLabel(PortaDe2Folhas);
        label->setObjectName("label");
        label->setGeometry(QRect(280, 30, 821, 161));
        QFont font;
        font.setFamilies({QString::fromUtf8("Matura MT Script Capitals")});
        font.setPointSize(72);
        font.setBold(false);
        label->setFont(font);
        pushButtonRefatorando = new QPushButton(PortaDe2Folhas);
        pushButtonRefatorando->setObjectName("pushButtonRefatorando");
        pushButtonRefatorando->setGeometry(QRect(780, 400, 211, 41));
        QFont font1;
        ...
        layoutWidget->setGeometry(QRect(350, 280, 311, 71));
        ...
        pushButtonLimpar = new QPushButton(PortaDe2Folhas);
        pushButtonLimpar->setObjectName("pushButtonLimpar");
        pushButtonLimpar->setGeometry(QRect(800, 580, 51, 41));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/imagens/limpar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        pushButtonLimpar->setIcon(icon1);
        pushButtonLimpar->setIconSize(QSize(24, 24));
        layoutWidget_2 = new QWidget(PortaDe2Folhas);
        layoutWidget_2->setObjectName("layoutWidget_2");
        layoutWidget_2->setGeometry(QRect(550, 580, 221, 41));
        ...
        layoutWidget_3 = new QWidget(PortaDe2Folhas);
        layoutWidget_3->setObjectName("layoutWidget_3");
        layoutWidget_3->setGeometry(QRect(550, 530, 221, 41));
        ...
        layoutWidget_4 = new QWidget(PortaDe2Folhas);
        layoutWidget_4->setObjectName("layoutWidget_4");
        layoutWidget_4->setGeometry(QRect(70, 280, 131, 71));
        ...
        layoutWidget_5 = new QWidget(PortaDe2Folhas);
        layoutWidget_5->setObjectName("layoutWidget_5");
        layoutWidget_5->setGeometry(QRect(670, 280, 181, 71));
        ...
        pushButtonDesconto = new QPushButton(PortaDe2Folhas);
        pushButtonDesconto->setObjectName("pushButtonDesconto");
        pushButtonDesconto->setGeometry(QRect(800, 480, 51, 41));
        QIcon icon2;
        ...
        layoutWidget_6 = new QWidget(PortaDe2Folhas);
        layoutWidget_6->setObjectName("layoutWidget_6");
        layoutWidget_6->setGeometry(QRect(210, 280, 131, 71));
        ...
        pushButtonCalcular = new QPushButton(PortaDe2Folhas);
        pushButtonCalcular->setObjectName("pushButtonCalcular");
        pushButtonCalcular->setGeometry(QRect(510, 480, 281, 41));
        ...
        pushButtonSalvar = new QPushButton(PortaDe2Folhas);
        pushButtonSalvar->setObjectName("pushButtonSalvar");
        pushButtonSalvar->setGeometry(QRect(800, 530, 51, 41));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/imagens/salvar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        pushButtonSalvar->setIcon(icon3);
        pushButtonSalvar->setIconSize(QSize(24, 24));
        layoutWidget_7 = new QWidget(PortaDe2Folhas);
        layoutWidget_7->setObjectName("layoutWidget_7");
        layoutWidget_7->setGeometry(QRect(340, 370, 211, 71));
        ...
        layoutWidget_8 = new QWidget(PortaDe2Folhas);
        layoutWidget_8->setObjectName("layoutWidget_8");
        layoutWidget_8->setGeometry(QRect(860, 280, 211, 71));
        ...
        layoutWidget_9 = new QWidget(PortaDe2Folhas);
        layoutWidget_9->setObjectName("layoutWidget_9");
        layoutWidget_9->setGeometry(QRect(560, 370, 211, 71));
        ...
        layoutWidget_11 = new QWidget(PortaDe2Folhas);
        layoutWidget_11->setObjectName("layoutWidget_11");
        layoutWidget_11->setGeometry(QRect(1080, 280, 211, 71));
    ...
    void retranslateUi(QDialog *PortaDe2Folhas)
    {
        ...
        label->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p>Porta de 2 Folhas</p></body></html>", nullptr));
        pushButtonRefatorando->setText(QCoreApplication::translate("PortaDe2Folhas", "Adicionais", nullptr));
        labelVidros->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Vidros</span></p></body></html>", nullptr));
        comboBoxVidros->setItemText(0, QString());

        pushButtonLimpar->setText(QString());
        label_6->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">LUCRO</span></p></body></html>", nullptr));
#if QT_CONFIG(whatsthis)
        lineEditLucro->setWhatsThis(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><br/></p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
        label_4->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">VALOR</span></p></body></html>", nullptr));
        labelLargura->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Largura</span></p></body></html>", nullptr));
        label_2->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Puxador</span></p></body></html>", nullptr));
        comboBoxPuxador->setItemText(0, QString());

        pushButtonDesconto->setText(QString());
        labelAltura->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Altura</span></p></body></html>", nullptr));
        pushButtonCalcular->setText(QCoreApplication::translate("PortaDe2Folhas", "CALCULAR", nullptr));
        pushButtonSalvar->setText(QString());
        label_7->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Pel\303\255cula</span></p></body></html>", nullptr));
        comboBoxPelicula->setItemText(0, QString());

        label_3->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Fechadura</span></p></body></html>", nullptr));
        comboBoxFechadura->setItemText(0, QString());

        label_5->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Trinco</span></p></body></html>", nullptr));
        comboBoxTrinco->setItemText(0, QString());

        label_9->setText(QCoreApplication::translate("PortaDe2Folhas", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Kit Alum\303\255nio</span></p></body></html>", nullptr));
