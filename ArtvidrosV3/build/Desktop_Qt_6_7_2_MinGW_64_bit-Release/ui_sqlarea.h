...
public:
    ...
    void setupUi(QDialog *SQLarea)
    {
        ...
        layoutWidget_2->setGeometry(QRect(410, 310, 201, 71));
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/imagens/botao-adicionar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        lineEditTipo = new QLineEdit(SQLarea);
        lineEditTipo->setObjectName("lineEditTipo");
        lineEditTipo->setGeometry(QRect(410, 390, 201, 31));
        pushButtonExcecao = new QPushButton(SQLarea);
        pushButtonExcecao->setObjectName("pushButtonExcecao");
        pushButtonExcecao->setGeometry(QRect(620, 350, 27, 27));
        checkBox = new QCheckBox(SQLarea);
        checkBox->setObjectName("checkBox");
        checkBox->setGeometry(QRect(620, 390, 21, 31));
    ...
    void retranslateUi(QDialog *SQLarea)
    {
        ...
        pushButtonExcecao->setText(QString());
