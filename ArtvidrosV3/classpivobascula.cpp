...
ClassPivoBascula::ClassPivoBascula()
{

}

ClassPivoBascula::ClassPivoBascula(float width, float height, const QString &glass, const QString &kit, const QString &film, const QString &lacth):
    HerdaPivoBasc(width,height,glass,kit,film,lacth)
{

}

float ClassPivoBascula::calculatePrice()
{
...
float ClassPivoBascula::calculateProfit()
{
    sqlDataBaseControl aux;
...
float ClassPivoBascula::metragem()
{
