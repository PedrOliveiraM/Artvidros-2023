...
public:
    ...
    bool deleteBDSalvar(QString codID,QString client,QString product,QString price,QString profit,QString data , QString seller);
    ...
    bool deleteBDVendido(QString codID,QString client,QString product,QString price,QString profit,QString data , QString seller);
